...
# Add the import for the custom dataset at the top
...
class Trainer:
    def __init__(self, options):
        ...
        self.depth_metric_names = [
            "de/abs_rel", "de/sq_rel", "de/rms", "de/log_rms", "de/a1", "de/a2", "de/a3"]
    ...
    def set_dataset(self):
        dataset_path = self.opt.data_path
        ...
        # For validation, you may want to create a separate validation set
    ...
    def compute_losses(self, inputs, outputs):
        ...
        for scale in self.opt.scales:
            ...
            # Ensure matching dimensions before computing smooth loss
            norm_disp = F.interpolate(norm_disp, size=color.shape[2:], mode='bilinear', align_corners=False)
